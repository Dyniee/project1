...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-IQRQA81\\SQLEXPRESS;Initial Catalog=EnglishPremierLeague2024DB;Persist Security Info=True;User ID=sa;Password=0401;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FootballClub>(entity =>
        {
            entity.HasKey(e => e.FootballClubId).HasName("PK__Football__91279504E9B23EF7");
        ...
        {
            entity.HasKey(e => e.FootballPlayerId).HasName("PK__Football__6D5466C343D0F82B");
        ...
        {
            entity.HasKey(e => e.AccId).HasName("PK__PremierL__91CBC3987636A38B");

            entity.ToTable("PremierLeagueAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__PremierL__49A1474045314133").IsUnique();
